...
URL: /docs/ui/openapi
Source: https://raw.githubusercontent.com/fuma-nama/fumadocs/refs/heads/main/apps/docs/content/docs/ui/openapi/index.mdx
...
<CodeBlockTabs defaultValue="lib/openapi.ts">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="lib/openapi.ts">
      lib/openapi.ts
    </CodeBlockTabsTrigger>
  ...
  <CodeBlockTab value="lib/openapi.ts">
    ```ts
...
<CodeBlockTabs defaultValue="components/api-page.tsx">
  <CodeBlockTabsList>
    <CodeBlockTabsTrigger value="components/api-page.tsx">
      components/api-page.tsx
    </CodeBlockTabsTrigger>

    <CodeBlockTabsTrigger value="components/api-page.client.tsx">
      components/api-page.client.tsx
    </CodeBlockTabsTrigger>
  </CodeBlockTabsList>

  <CodeBlockTab value="components/api-page.tsx">
    ```tsx
  ...
  <CodeBlockTab value="components/api-page.client.tsx">
    ```tsx
    'use client';
